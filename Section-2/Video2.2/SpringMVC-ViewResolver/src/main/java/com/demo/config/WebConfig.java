...
public class WebConfig implements WebMvcConfigurer {
	...
	/*
	 * @Autowired CustomHandlerInterceptor customHandlerInterceptor;
	 * 
	 * @Override public void addInterceptors(InterceptorRegistry registry) {
	 * registry.addInterceptor(customHandlerInterceptor)
	 * .addPathPatterns("/info") .excludePathPatterns("/downTime"); }
	 * 
	 * @Bean public RequestMappingHandlerMapping requestMappingHandlerMapping()
	 * { RequestMappingHandlerMapping reqHandlerMapping = new
	 * RequestMappingHandlerMapping();
	 * reqHandlerMapping.setInterceptors(customHandlerInterceptor); return
	 * reqHandlerMapping; }
	 * 
	 * @Bean public CustomHandlerInterceptor customHandlerInterceptor() { //
	 * TODO Auto-generated method stub return new CustomHandlerInterceptor(); }
	 */
}
